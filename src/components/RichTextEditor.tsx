...
const JP_LEGEND_HTML = `<div style="margin-top:10px;padding:8px 12px;border-radius:6px;border:1px solid #333;background:#1a1a2e;display:flex;flex-wrap:wrap;gap:6px 12px;font-size:11px;line-height:1.6"><span style="font-weight:700;color:#aaa;width:100%;margin-bottom:2px">🎨 Color Key</span><span><mark style="background-color:#be123c;color:#fff;padding:1px 5px;border-radius:3px;font-size:10px">Verb</mark></span><span><mark style="background-color:#1e3a8a;color:#fff;padding:1px 5px;border-radius:3px;font-size:10px">Particle</mark></span><span><mark style="background-color:#14532d;color:#fff;padding:1px 5px;border-radius:3px;font-size:10px">Place</mark></span><span><mark style="background-color:#78350f;color:#fff;padding:1px 5px;border-radius:3px;font-size:10px">Time</mark></span><span><mark style="background-color:#581c87;color:#fff;padding:1px 5px;border-radius:3px;font-size:10px">Noun</mark></span><span><mark style="background-color:#7c2d12;color:#fff;padding:1px 5px;border-radius:3px;font-size:10px">Adjective</mark></span><span><mark style="background-color:#831843;color:#fff;padding:1px 5px;border-radius:3px;font-size:10px">Adverb</mark></span><span><mark style="background-color:#134e4a;color:#fff;padding:1px 5px;border-radius:3px;font-size:10px">Greeting</mark></span><span><mark style="background-color:#374151;color:#fff;padding:1px 5px;border-radius:3px;font-size:10px">Other</mark></span></div>`;
